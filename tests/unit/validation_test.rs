...
mod tests {
    ...
    fn test_version_format_validation() {
        ...
        for version in valid_versions {
            let ext = ExtensionBuilder::new("test").with_version(version).build();
