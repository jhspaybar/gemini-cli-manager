...
mod tests {
    ...
    fn test_keyboard_navigation() {
        ...
        // Left arrow to "Yes"
        dialog.handle_events(Some(create_key_event(KeyCode::Left))).unwrap();
        assert_eq!(dialog.selected_option(), 0);
        
        // Right arrow back to "No"
        dialog.handle_events(Some(create_key_event(KeyCode::Right))).unwrap();
        assert_eq!(dialog.selected_option(), 1);
        
        // Tab also works
        dialog.handle_events(Some(create_key_event(KeyCode::Tab))).unwrap();
        assert_eq!(dialog.selected_option(), 0);
    }
    ...
    fn test_confirm_yes() {
        ...
        let result = dialog.handle_events(Some(create_key_event(KeyCode::Enter))).unwrap();
    ...
    fn test_escape_cancels() {
        ...
        // Press Escape
        let result = dialog.handle_events(Some(create_key_event(KeyCode::Esc))).unwrap();
    ...
    fn test_y_key_confirms() {
        ...
        let result = dialog.handle_events(Some(create_key_event(KeyCode::Char('y')))).unwrap();
    ...
    fn test_n_key_cancels() {
        ...
        let result = dialog.handle_events(Some(create_key_event(KeyCode::Char('n')))).unwrap();
    ...
    fn test_space_selects() {
        ...
        let result = dialog.handle_events(Some(create_key_event(KeyCode::Char(' ')))).unwrap();
