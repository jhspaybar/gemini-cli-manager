...
mod tests {
    ...
    fn test_default_profile_selection() {
        ...
        list.handle_events(Some(create_key_event(KeyCode::Char('x')))).unwrap();
    ...
    fn test_profile_search() {
        ...
        // Search for "dev"
        list.handle_events(Some(create_key_event(KeyCode::Char('d')))).unwrap();
        list.handle_events(Some(create_key_event(KeyCode::Char('e')))).unwrap();
        list.handle_events(Some(create_key_event(KeyCode::Char('v')))).unwrap();
