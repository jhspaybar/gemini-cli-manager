...
mod tests {
    ...
    async fn test_navigate_back_from_various_views() {
        ...
        vm.update(Action::ViewProfileDetails("test-profile".to_string())).unwrap();
    ...
    async fn test_navigate_back_from_edit_views() {
        ...
        // Edit from list view
        vm.update(Action::EditExtension("test-extension".to_string())).unwrap();
    ...
    async fn test_confirm_delete_profile() {
        ...
        vm.update(Action::NavigateToProfiles).unwrap();
        vm.update(Action::DeleteProfile("deletable-profile".to_string())).unwrap();
    ...
    async fn test_cancel_delete() {
        ...
        // Start delete flow
        vm.update(Action::DeleteExtension("keep-extension".to_string())).unwrap();
        assert_eq!(vm.current_view(), ViewType::ConfirmDelete);
    ...
    async fn test_delete_extension_referenced_by_profile() {
        ...
        vm.update(Action::DeleteExtension("referenced-extension".to_string())).unwrap();
    ...
    async fn test_init_with_size() {
        ...
        // Test init
        let result = vm.init(Size { width: 80, height: 24 });
        assert!(result.is_ok());
    }
    ...
    async fn test_confirm_delete_extension_from_detail() {
        ...
        vm.update(Action::ViewExtensionDetails("delete-from-detail".to_string())).unwrap();
        vm.update(Action::DeleteExtension("delete-from-detail".to_string())).unwrap();
        assert_eq!(vm.current_view(), ViewType::ConfirmDelete);
