...
impl ThemeTestHelper {
    ...
    pub fn test_focus_visibility(flavour: ThemeFlavour) -> bool {
        ...
        // Border focused should have good contrast with background
        Self::contrast_ratio(theme::border_focused(), theme::background()) >= 3.0
    }
}
...
mod tests {
    ...
    fn test_wcag_compliance() {
        ...
        // Dark gray on black should fail
        assert!(!ThemeTestHelper::meets_wcag_aa(Color::DarkGray, Color::Black));
    }
}